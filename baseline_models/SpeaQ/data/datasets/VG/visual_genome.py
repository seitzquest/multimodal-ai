...
class VisualGenomeTrainData:
    ...
    def __init__(self, cfg, split='train'):
        ...
        try:
            ...
            pass
        if self.bgnn:
            freq = self.statistics['fg_rel_count'] / self.statistics['fg_rel_count'].sum()
            freq = freq.numpy()
            ...
            MetadataCatalog.get('VG_{}'.format(self.split)).set(statistics=self.statistics)
            print (self.idx_to_predicates, self.statistics['fg_rel_count'].numpy().tolist())
