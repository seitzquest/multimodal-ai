...
def get_args_parser():
    ...
    parser.add_argument('--mode', default="shape", type=str)
    parser.add_argument('--patch_strategy', default="fully_random", type=str)
    parser.add_argument('--obj_in_rl', action='store_true')
    return parser
...
def main(args):
    ...
    if args.eval:
        ...
        test_stats, coco_evaluator = evaluate(model, criterion, postprocessors, data_loader_val, base_ds, device, args.mode, args.scaling, args.patch_strategy, args.obj_in_rl, args)
        if args.output_dir:
